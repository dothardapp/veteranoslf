...
admin.ajax = {
    ...
    get: function (url, data, result_function) {
        ...
        // Este bloque de código implementa la carga condicional del script 'vista_sorteos.js' 
        // para la página específica que termina con '/vista_zonas'. Es una estrategia eficiente 
        // para cargar scripts únicamente donde se necesitan, mejorando el rendimiento general de la aplicación. 
        // Esta modificación fue realizada para asegurar que 'vista_sorteos.js' solo se cargue 
        // en el contexto adecuado, optimizando así la carga de recursos y la ejecución de scripts.
        // Modificación realizada por Joselo.

        if (response.request.responseURL.endsWith('/vista_zonas')) {
            
            var script = document.createElement('script');
            script.src = '/js/vista_sorteos.js';
